...
export default function Image_Hero() {
  ...
  const downloadImage = async () => {
    ...
    try {
      ...
      alert(
        'Failed to download image. Please try the "Open in New Tab" button instead.',
      );
    }
  };
    ...
    <>
      <div className="min-h-screen bg-black  flex items-center ">
        <div className=" mx-auto space-y-6  ">
          <h1 className="text-white text-9xl mt-8 -ml-44 text-center bitcount-prop-single-uniqifier">
            Image Arena
          </h1>
