...
function VideoArena() {
  ...
  const renderFeatureComponent = () => {
    ...
    switch (selectedFeature) {
      ...
      case 'thumbnails':
        return <ThumbnailExtractor video={inputFile} outputUrl={videoPreviewUrl} />;
      case 'audio':
      ...
      case 'compress':
        return <VideoCompressor video={inputFile} outputUrl={videoPreviewUrl} />;
      default:
        return null;
    }
  };
  ...
  return(
    <div className="bg-black min-h-screen text-white">
       ...
       <h1 className="text-9xl text-center pt-6 bitcount-prop-single-uniqifier text-white">Video Arena</h1>
       <p className="text-center mt-4 text-2xl text-gray-200">Professional video modification tools at your fingertips</p>
      {
        !inputFile ?  (
